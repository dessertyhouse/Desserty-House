...
export function applyOverrides(data: GalleryData): (ShowcaseItem & { hidden?: boolean })[] {
...
export function customAsItems(
  data: GalleryData,
  instagram: string
): (ShowcaseItem & { hidden?: boolean; custom: true })[] {
 ...
 */
export async function getGalleryItems(): Promise<ShowcaseItem[]> {
