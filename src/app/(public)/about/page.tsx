      ...
      <section className="shell section">
        ...
        <div className="prose">
          {content.aboutBlocks.map((block) => (
            <section key={block.heading} className="prose-block">
              <h2>{block.heading}</h2>
              <p>{block.body}</p>
            </section>
          ))}
          ...
          <section className="prose-block">
            ...
            <p>
              ...
              <Link href="/showcase">gallery of previous creations</Link>, pick a style code, and
              send your date, quantity and preferences through the{' '}
              <Link href="/order">order form</Link> or directly on{' '}
              <a href={waOrderLink(settings)} rel="noopener">
                WhatsApp
              </a>
              . We deliver across {settings.deliveryAreas.join(', ')} and nearby localities — see
              the <Link href="/shipping-policy">delivery policy</Link>.
            </p>
          </section>
          ...
          <p>
            ...
            and the <Link href="/feedback">feedback wall</Link>, or get in touch via the{' '}
