...
function OrderForm({ productOptions }: { productOptions: ProductOption[] }) {
  const products = productOptions.length ? productOptions : staticProducts;
...
export default function OrderClient({ productOptions = [] }: { productOptions?: ProductOption[] }) {
  return (
    <Suspense fallback={
      <main className="shell section">
