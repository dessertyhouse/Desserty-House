    ...
    <main>
      ...
      <section className="showcase-hero">
        <div className="shell">
          ...
          <p>
            Genuine messages and screenshots shared by our customers after their orders. Want to
            share yours? Send it on <a href={site.whatsapp} rel="noopener">WhatsApp</a> or tag us on{' '}
