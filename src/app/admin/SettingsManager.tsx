    ...
    <div className="settings-manager">
      ...
      <form onSubmit={save} className="post-form settings-form">
        ...
        <p className="muted post-submit-hint">
          Address, policies, product descriptions and prices still live in the code —
          ask your developer (or the AI assistant) to change those.
        </p>
      </form>
    </div>
  );
